	...
	theme: {
		...
		extend: {
			colors: {
				...
				'theme-hero-bg': 'hsl(var(--theme-hero-bg))',
				'theme-hero-text': 'hsl(var(--theme-hero-text))',
				'theme-button-primary': 'hsl(var(--theme-button-primary))',
				'theme-button-primary-hover': 'hsl(var(--theme-button-primary-hover))',
				'theme-footer-bg': 'hsl(var(--theme-footer-bg))',
				'theme-footer-text': 'hsl(var(--theme-footer-text))'
			},
			borderRadius: {
				lg: 'var(--radius)',
